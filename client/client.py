...
class Client():
    def __init__(self, device, model_func, received_vecs, dataset, lr, args):
        ...
        self.dataset = data.DataLoader(Dataset(dataset[0], dataset[1], train=True, dataset_name=self.args.dataset, args=self.args), batch_size=self.args.batchsize, shuffle=True)
